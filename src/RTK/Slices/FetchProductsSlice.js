...
export const FetchProducts = createAsyncThunk(
  "FetchProductsSlice/fetchProducts",
  async (pageNumber, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}api/v1/products?page=${pageNumber}`,
      {
        headers: {
...
export const FetchMostSoldProducts = createAsyncThunk(
  "FetchProductsSlice/fetchMostSoldProducts",
...
export const FetchNewArrivals = createAsyncThunk(
  "FetchProductsSlice/fetchNewArrivals",
  async (options = "", { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    const response = await axios.get(
...
export const FetchCertainProduct = createAsyncThunk(
  "FetchProductsSlice/fetchCertainProducts",
  async (id, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}api/v1/products/${id}`,
      {
        headers: {
          currency: countryCurrency,
        },
...
export const GetAllCategories = createAsyncThunk(
  "FetchProductsSlice/getAllCategories",
  async (_, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    try {
      const response = await axios.get(
...
export const GetSpecificCategory = createAsyncThunk(
  "FetchProductsSlice/getSpecificCategory",
  async (category_id, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}api/v1/categories/${category_id}`,
        {
          headers: {
            "accept-language": i18next.language,
            currency: countryCurrency,
...
export const GetAllSubCategories = createAsyncThunk(
  "FetchProductsSlice/getAllSubCategories",
  async (_, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    try {
      const response = await axios.get(
        process.env.REACT_APP_BASE_URL + "api/v1/subcategory",
        {
          headers: {
            "accept-language": i18next.language,
            currency: countryCurrency,
...
export const GetSpecificSubCategory = createAsyncThunk(
  "FetchProductsSlice/getSpecificSubCategory",
  async (subCategory_id, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}api/v1/subcategory/${subCategory_id}`,
        {
          headers: {
            "accept-language": i18next.language,
            currency: countryCurrency,
...
export const GetAllAuthors = createAsyncThunk(
  "FetchProductsSlice/getAllAuthors",
  async (_, { getState }) => {
    const { countryCurrency } = getState().SelectCountry;
    try {
      const response = await axios.get(
        process.env.REACT_APP_BASE_URL + "api/v1/authors",
        {
          headers: {
            currency: countryCurrency,
          },
