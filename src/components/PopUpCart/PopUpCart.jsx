        ...
        <table className="table">
          <thead>
            <tr className="fw-bold">
              <th className="image product-text text-center" scope="col">
                {t("Image")}
              </th>
              <th className="product-text" scope="col">
                {t("product")}
              </th>
              <th className="product-text" scope="col">
                {t("qty")}
          ...
          {!(CartProducts ? CartProducts.length : 0) && (
            <caption>
              <div className="w-100 px-2">
                <p className="no-items w-100 text-center text-white no-items py-2 rounded">
                  {t("no items")}
                </p>
              </div>
            </caption>
        ...
        <div className="options position-sticky bottom-0 bg-white pb-2 d-flex justify-content-end">
          <div className="close px-1">
            <button
              ...
              type="button"
              className="btn btn-primary product-text button-resp"
            >
              {t("Close")}
            </button>
          </div>
