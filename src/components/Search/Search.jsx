...
function Search(props) {
  ...
  useEffect(() => {
    axios
      .get(process.env.REACT_APP_BASE_URL + "api/v1/products/", {
        params: {
                      ...
                      <th>
                        <div className="d-flex align-items-center">
                          <div className="image-container d-none d-md-block p-2">
                            <img
                              src={`${process.env.REACT_APP_BASE_URL}products/images/${product.image}`}
                              alt=""
                            />
                          </div>
              ...
              {!searchResults.length && (
                <caption className="text-center">
                  <div className="w-100 px-2">
                    <p className="w-100 text-center no-items py-2 rounded">
                      {t("no items")}
                    </p>
                  </div>
                </caption>
